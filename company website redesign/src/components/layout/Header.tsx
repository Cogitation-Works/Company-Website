          ...
          <div className="container-page flex h-16 items-center justify-between gap-6 lg:h-20">
            ...
            <div className="flex items-center gap-3">
              <Magnetic className="hidden lg:inline-block">
                {/* To our own contact page, NOT straight out to the booking
                    calendar. The calendar link lives on that page. Sending the
                    header button offsite left no route to /contact at all. */}
                <a
                  href="/contact"
