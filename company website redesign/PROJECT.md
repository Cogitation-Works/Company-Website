...
| | *next: client generates §4.7 (7 industry films) and §4.6 (3 films + 5 stills); records the product and client screens, and the 6 client review videos. **Still needed from the client: the Robotics scope, the Sunday-delivery service area and cut-off, and real testimonials** — which now block every product and project page* |
